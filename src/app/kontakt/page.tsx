...
// Die Seite ist force-dynamic, das Lesen der searchParams kostet nichts und die
// Canonical bleibt parameterlos. Eine Detailseite verlinkt hierher als
// `/de/kontakt/?icao=EDNY` (oder `?ref=<slug>` fuer ICAO-lose Felder);
// buildContactPrefill sanitisiert die Referenz und leitet die Vorbelegung ab.
export default async function KontaktPage({
  searchParams,
}: {
  searchParams: Promise<Record<string, string | string[] | undefined>>;
}) {
  const prefill = buildContactPrefill(await searchParams, "de");
  return (
    <LegalShell
      lang="de"
      title="Kontakt"
